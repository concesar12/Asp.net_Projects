...
namespace Services
{
    public class PersonsService :IPersonsService
    {
            ...
            using (Operation.Time("Time for filtered persons from DB"))
            {
...

                {
                    nameof(PersonResponse.PersonName) =>
                     ...
                     temp.PersonName.Contains(searchString)), //no necessity to crate a null condition since at runtime sql will give the error
        ...
        public List<PersonResponse> GetSortedPersons(List<PersonResponse> allPersons, string sortBy, SortOrderOptions sortOrder)
        {
            ...
            List<PersonResponse> sortedPersons = (sortBy, sortOrder) switch // Switch validation of two values
            {
                ...
                _ => allPersons // the "_" Represents the default case
            };
        ...
        public async Task<MemoryStream> GetPersonsExcel()
        {
            ...
            using (ExcelPackage excelPackage = new ExcelPackage(memoryStream)) // Excel package lets us to create worksheets
            {
                ...
                foreach (PersonResponse person in persons)
                {
                    workSheet.Cells[row, 1].Value = person.PersonName; //[row, column]
                ...
                workSheet.Cells[$"A1:H{row}"].AutoFitColumns(); //Automatically fits the colooumn width
